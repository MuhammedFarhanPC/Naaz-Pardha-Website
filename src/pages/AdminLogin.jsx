...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-brand-beige py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        <div>
          <h2 className="mt-2 text-center text-4xl font-serif text-brand-black tracking-tight">
            NAAZ<span className="text-brand-gold">.</span> Admin
          </h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-brand-black bg-brand-gold hover:bg-[#b0922f] focus:outline-none transition-colors"
            >
              Sign in
            </button>
          </div>
        ...
        <div className="text-center mt-6">
          <a href="/" className="text-sm font-medium text-gray-400 hover:text-brand-gold transition-colors">
